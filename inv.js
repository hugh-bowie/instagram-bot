...
(async () => {
	try {
		...
		await page.waitForSelector('img[alt="GitLab Logo"]');
		await page.waitForTimeout(8000);
		await page.tap('#user_login');
		await page.type('#user_login', process.env.GIT);
		...
		//---- got to activity
		await page.goto('https://gitlab.com/users/hughbowie/activity', { waitUntil: 'networkidle2' });
